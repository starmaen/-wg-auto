...
object Defaults {
    val dns: List<DnsServer> = listOf(
        DnsServer("def-cloudflare", "Cloudflare", "1.1.1.1", "1.0.0.1"),
        DnsServer("def-cloudflare-sec", "Cloudflare (حماية)", "1.1.1.2", "1.0.0.2"),
        DnsServer("def-google", "Google", "8.8.8.8", "8.8.4.4"),
        DnsServer("def-quad9", "Quad9", "9.9.9.9", "149.112.112.112"),
        DnsServer("def-opendns", "OpenDNS", "208.67.222.222", "208.67.220.220"),
        DnsServer("def-adguard", "AdGuard", "94.140.14.14", "94.140.15.15"),
        DnsServer("def-cleanbrowsing", "CleanBrowsing", "185.228.168.9", "185.228.169.9"),
        DnsServer("def-controld", "Control D", "76.76.2.0", "76.76.10.0"),
        DnsServer("def-nextdns", "NextDNS", "45.90.28.0", "45.90.30.0"),
        ...
        DnsServer("def-dnssb", "DNS.SB", "185.222.222.222", "45.11.45.11"),
        DnsServer("def-mullvad", "Mullvad", "194.242.2.2", "")
    )
}
